// src/compoments/ManualAddModal.jsx
...
export default function ManualAddModal({ onAdd, onClose }){
    const [courseName, se4tCourseName]= useState('')
                    ...
                    <div className="modal-body">
                        ...
                        <div className="field-group">
                            ...
                            <input
                                ...
                                placeholder="예: 융합캡스톤디자인"
                                value={courseName}
                                onChange={e=> {se4tCourseName(e.target.value); setError('')}}
                                onKeyDown={onKeyDown}
                                autoFocus
                                />
                        </div>
                        ...
                        <div className="modal-row">
                            ...
                            <div className="modal-field">
                                    <label classNHame="field-label">구분</label>
                                    <select 
                                        className="modal-select"
                                        value={category}
